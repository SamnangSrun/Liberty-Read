...
const animeBooks = data.books.filter(
  (book) =>
    ["Comics", "Novel","anime"].includes(book.category?.name?.toLowerCase()) &&
    ...
    <div className="px-2 sm:px-4">
      <div className="flex flex-col sm:flex-row justify-between items-start mb-4">
        <div className="mb-2 sm:mb-0">
          <h1 className="text-xl sm:text-2xl font-bold">Comics & Graphic Novels</h1>
          <p className="text-sm sm:text-base">Explore our collection of anime-related books.</p>
        </div>
        {books.length > 8 && (
          <button
