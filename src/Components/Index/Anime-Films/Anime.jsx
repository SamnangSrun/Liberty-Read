...
const Fitness = ({ showAll, setShowAll }) => {
    ...
    fetch(`${config.base_url_api}books`)
      ...
      .then((data) => {
        const animeBooks = data.books.filter(
          (book) =>
            book.category?.name?.toLowerCase() === "anime" &&
  ...
  <div className="mb-2">
    <h1 className="text-sm sm:text-base font-bold">Comics</h1>
    <h1 className="text-xl sm:text-3xl m-2 text-[#102249] font-bold">Comics</h1>
